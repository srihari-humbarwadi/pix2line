...
p_unet.compile(optimizer='adam', loss='sparse_categorical_crossentropy', metrics=['mse','accuracy'])
tb = TensorBoard(log_dir='logs', write_graph=True)
mc = ModelCheckpoint(mode='max', filepath='enet_model/top_weightsd.h5', monitor='acc', save_best_only='True', save_weights_only='True', verbose=2)
...
unet.save_weights('enet_model/enet.h5')
